      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
        ...
        <div className="md:col-span-12 lg:col-span-6 flex gap-4 overflow-x-auto pb-1">
          <div className="min-w-[320px] bg-secondary-container rounded-xl p-md shadow-sm flex flex-col justify-between">
            ...
            <a
              className="mt-4 flex items-center gap-2 text-on-secondary-container font-bold text-sm hover:gap-3 transition-all cursor-pointer"
              href="#"
            >
              Read Full Study <Icon name="arrow_forward" className="text-sm" />
            </a>
          </div>
          <div className="relative min-w-[320px] bg-tertiary-container text-on-tertiary-container rounded-xl p-md shadow-sm flex flex-col justify-between overflow-hidden">
            ...
            <a
              className="mt-4 relative z-10 flex items-center gap-2 text-on-tertiary-container font-bold text-sm hover:gap-3 transition-all cursor-pointer"
              href="#"
            >
              View Attendance Correlates <Icon name="arrow_forward" className="text-sm" />
            </a>
          </div>
        </div>
      </div>

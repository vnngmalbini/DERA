...
export default function GrowthLibrarian() {
  ...
  return (
    <>
      <DashboardPageHeader
        title="AI Growth Librarian"
        description="Tell me about your goals, career interests, or what you're working through, and I'll recommend books that actually fit where you are right now."
      />

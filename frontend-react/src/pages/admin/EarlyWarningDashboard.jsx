  ...
  return (
    <AdminLayout>
      <section className="mb-xl">
        <h2 className="font-headline-lg text-headline-lg text-primary mb-2">Akwaaba, Kwame</h2>
        ...
        <section className="lg:col-span-8">
          <div className="bg-white rounded-2xl shadow-sm border border-outline-variant/20 overflow-hidden h-full flex flex-col">
            ...
            <div className="p-4 bg-surface-container-lowest flex justify-center border-t border-outline-variant/10 mt-auto">
              <Link to="/admin/roster" className="text-primary font-bold hover:underline flex items-center gap-2">
                View Full Roster
      ...
      <button
        ...
        className="fixed bottom-8 right-8 bg-primary text-on-primary w-14 h-14 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center active:scale-95 transition-all z-40"
      >
